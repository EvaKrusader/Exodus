...
import net.mcreator.exodus.init.*;
...
public class ExodusMod {
	...
	public ExodusMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(ExodusModCuriosCompat::registerCapabilities);
			modEventBus.addListener(ExodusModCuriosRenderers::registerRenderers);
		}
