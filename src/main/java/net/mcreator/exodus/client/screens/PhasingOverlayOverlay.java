...
import net.mcreator.exodus.procedures.PhasingOverlayDisplayOverlayIngameProcedure;

@EventBusSubscriber(Dist.CLIENT)
public class PhasingOverlayOverlay {
	private static final Identifier BACKGROUND = Identifier.parse("exodus:textures/screens/phasing_overlay.png");
