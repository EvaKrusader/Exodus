...
import net.mcreator.exodus.procedures.PhasingOverlayDisplayOverlayIngame2Procedure;

@EventBusSubscriber(Dist.CLIENT)
public class PhasingOverlay2Overlay {
	private static final Identifier BACKGROUND = Identifier.parse("exodus:textures/screens/phasing_overlay2.png");
