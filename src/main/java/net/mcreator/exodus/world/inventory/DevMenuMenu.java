package net.mcreator.exodus.world.inventory;
...
public class DevMenuMenu extends AbstractContainerMenu implements ExodusModMenus.MenuAccessor {
	...
	public DevMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ExodusModMenus.DEV_MENU.get(), id);
