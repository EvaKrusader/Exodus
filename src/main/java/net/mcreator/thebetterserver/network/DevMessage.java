...
import net.mcreator.thebetterserver.procedures.DevOnKeyPressedProcedure;
...
public record DevMessage(int eventType, int pressedms) implements CustomPacketPayload {
	public static final Type<DevMessage> TYPE = new Type<>(Identifier.fromNamespaceAndPath(TheBetterServerMod.MODID, "key_dev"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		TheBetterServerMod.addNetworkMessage(DevMessage.TYPE, DevMessage.STREAM_CODEC, DevMessage::handleData);
	}
}