...
public class ScaldingCalidiumOreDropProcProcedure {
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		if (entity == null)
			return;
		if (itemstack.getItem() == TheBetterServerModItems.SCALDING_CALIDIUM.get()) {
			TheBetterServerMod.queueServerWork(100, () -> {
				itemstack.shrink(1);
				if (entity instanceof Player _player) {
					ItemStack _setstack = new ItemStack(TheBetterServerModItems.CALIDIUM.get()).copy();
