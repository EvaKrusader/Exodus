package net.mcreator.thebetterserver;
...
import net.mcreator.thebetterserver.init.*;
...
@Mod("the_better_server")
public class TheBetterServerMod {
	public static final Logger LOGGER = LogManager.getLogger(TheBetterServerMod.class);
	public static final String MODID = "the_better_server";

	public TheBetterServerMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);
		if (ModList.get().isLoaded("curios")) {
			modEventBus.addListener(TheBetterServerModCuriosCompat::registerCapabilities);
			modEventBus.addListener(TheBetterServerModCuriosRenderers::registerRenderers);
		}
		...
		TheBetterServerModPotions.REGISTRY.register(modEventBus);
		TheBetterServerModMobEffects.REGISTRY.register(modEventBus);
