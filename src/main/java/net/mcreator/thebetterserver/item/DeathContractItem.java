...
import net.mcreator.thebetterserver.procedures.DeathContractItemInInventoryTickProcedure;
import net.mcreator.thebetterserver.procedures.DeathContractIsSignedTextureProcedure;
