package net.mcreator.thebetterserver.client.model;
...
public class Modellustar_halo extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("the_better_server", "modellustar_halo"), "main");
